                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Reporte de preturnos</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <section class="table-section section_general">
                                ...
                                <table id="tablaUsuarios" class="modern-table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Username</th>
                            ...
                            <section class="charts section_general">
                                <div class="chart-card">
                                    <div id="h5pBarChart" style="margin-top:30px;"></div>
                                </div>
                            </section>
                            <section class="charts section_general">
                                <div class="chart-card">
                                    <div id="sectionComplianceChart" style="margin-top:30px;"></div>
                                </div>
                            </section>
                        </div>
                    </div>
