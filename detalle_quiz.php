                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Reporte de certificaciones</h6>
                        </div>
                        <div class="card-body">
                            <section class="section_general">
                                <div class="filters">
                                    <div class="filter-group date-filters">
                                        ...
                                        <label>
                                            Estudiante
                                            <select id="studentSelectQuiz" class="form-control">
                                                <option value="">Todos</option>
                                            </select>
                                        </label>
                                        <div class="sub-filter-group">
                            ...
                            <section class="section_general">
                                <div class="kpi-cards">
                                    ...
                                    <div class="kpi-card">
                                        <h6>Total certificaciones</h6>
                                        <h3 id="kpiTotalQuiz">0</h3>
                                    </div>

                                    <div class="kpi-card">
                                        <h6>Realizados</h6>
                                        <h3 id="kpiDoneQuiz">0</h3>
                                    </div>

                                    <div class="kpi-card">
                                        <h6>Pendientes</h6>
                                        <h3 id="kpiPendingQuiz">0</h3>
                                    </div>
                            ...
                            <section class="table-section section_general">
                                <div id="quizLoader" style="display:none; text-align:center; padding:20px;">
                                    <div class="spinner-border text-primary" role="status"></div>
                                    <div>Cargando información...</div>
                                </div>

                                <table id="tablaUsuariosQuiz" class="modern-table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Username</th>
                                            ...
                                            <th>Último login</th>
                                            <th>Total H5P</th>
                                            <th>H5P completadas</th>
                                            <th>H5P pendientes</th>
                                            <th>Cumplimiento</th>
                            ...
                            <section class="charts section_general">
                                <div class="chart-card">
                                    <div id="h5pBarChartQuiz" style="margin-top:30px;"></div>
                                </div>
                            </section>
                            <section class="charts section_general">
                                <div class="chart-card">
                                    <div id="sectionComplianceChartQuiz" style="margin-top:30px;"></div>
                                </div>
                            </section>
                        </div>
                    </div>
