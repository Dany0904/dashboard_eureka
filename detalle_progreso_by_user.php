                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <p>Da clic en el bóton (Detalle) para ver el avance de cursos en el que el usuario esta inscrito</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable_todos_users" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                        </tr>
                                    </thead>
                                ...
                                <div class="card shadow mb-4" id="detalleCursosCard_users" style="display: none;">
