                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Cursos con Promedios</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable_cursos_promedios" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th></th>
                                ...
                                <div class="card shadow mb-4" id="detalleActividadesCard_activities" style="display: none;">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Actividades del Curso: <span id="cursoNombre"></span></h6>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
...
<style>
    ...
    #detalleActividadesCard_activities {
        display: none;
        opacity: 0;
