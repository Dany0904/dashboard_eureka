                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Reporte por horas</h6>
                        </div>
                        <div class="card-body">
                            <section class="filters-section section_general">
                                <div class="filters">
                                    <div class="filter-group">
                                        ...
                                        <label style="width: inherit;">
                                            ...
                                            <select id="actividadSelect" class="form-control">
                                                <option value="hvp">Preturnos</option>
                                                <option value="quiz">Certificaciones</option>
                                            </select>
                                        </label>
                            ...
                            <section class="table-section section_general">
                                ...
                                <table id="tablaSecciones" class="modern-table" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Sección</th>
                            ...
                            <section class="section_general">
                                <div id="chartHoras" style="height: 400px; margin-bottom: 30px;"></div>
                                <div id="chartPorcentaje" style="height: 400px; margin-bottom: 30px;"></div>
                            </section>
                        </div>
                    </div>
