                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Cursos por Año</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable_cursos_anio" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Año</th>
                                            <th>Total</th>
                            ...
                            <div class="card shadow mb-4" id="detalleCursosCard" style="display: none;">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" style="color: #2949c2 !important;">Cursos del Año: <span id="detalleAnio"></span></h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable_detalle_cursos" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ID Curso</th>
